...
class CreateCdrTest {
    ...
    void createCdrSuccess() throws Exception {
        mockMvc.perform(post("/cdr")
                        ...
                        .content("{\"sessionIdentification\":\"1213\",\"vehicleIdentification\":\"VH001\",\"startAt\":\"2024-05-19T15:10:00Z\",\"endAt\":\"2024-05-19T15:10:01Z\",\"amount\":1.2}"))
    ...
    void createCdrFailEmptyBody() throws Exception {
        mockMvc.perform(post("/cdr")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.errorDescription").value("Invalid request body"));
    }
