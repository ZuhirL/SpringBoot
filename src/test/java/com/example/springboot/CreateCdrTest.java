...
class CreateCdrTest {
  ...
  void createCdrSuccess() throws Exception {
    mockMvc.perform(post("/cdr")
            ...
            .content(
                "{\"sessionIdentification\":\"1213\",\"vehicleIdentification\":\"VH001\",\"startAt\":\"2024-05-19T15:10:00Z\",\"endAt\":\"2024-05-19T15:10:01Z\",\"amount\":1.2}"))
  ...
  void createCdrFailWronRange() throws Exception {
    mockMvc.perform(post("/cdr")
            .contentType(MediaType.APPLICATION_JSON)
            .content(
                "{\"sessionIdentification\":\"1213\",\"vehicleIdentification\":\"VH001\",\"startAt\":\"2023-05-18T15:10:00Z\",\"endAt\":\"2024-05-19T15:10:01Z\",\"amount\":1.2}"))
        .andExpect(status().isBadRequest())
